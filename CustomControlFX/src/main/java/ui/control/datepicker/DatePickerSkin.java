...
public class DatePickerSkin extends SkinBase<DatePickerControl>{
  ...
  public DatePickerSkin(DatePickerControl datePickerControl) {
    ...
    String formTextClassName = datePickerControl.getFormTextStyleClass();
    String calendarFormButtonClassName = datePickerControl.getFormButtonStyleClass();
    textFieldCheckState = datePickerControl.isTextFieldCheckState();

    textField.setPrefWidth(fieldWidth);
    textField.setPrefHeight(fieldHeight);
    textField.setMinHeight(fieldHeight);
    textField.getStyleClass().add(formTextClassName);
    textField.setEditable(textFieldCheckState);
    ...
    calendarButton.getStyleClass().setAll(calendarFormButtonClassName);
    if(calendarFormButtonClassName.equals("calendar-form-button-dark")){
      calendarButton.setGraphic(
        new ImageView(new Image(getClass().getResourceAsStream("/commons/ui/control/datepicker/image/calendar_white.png"))));
    }else {
      calendarButton.setGraphic(
