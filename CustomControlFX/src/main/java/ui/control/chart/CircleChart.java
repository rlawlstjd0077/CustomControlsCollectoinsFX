...
/**
 * Created by JinSeong on 2017-01-24.
 */
public class  CircleChart extends StackPane {
  ...
  public CircleChart(){
    getStylesheets().add(getClass().getResource("circlechart.css").toExternalForm());
   ...
   * @param series1Data
   */
  public void setDatas(ObservableList<XYChart.Series<Number, Number>> series1Data){
    coreChart.setData(series1Data);
  }
