...
import fds.ui.common.TabTextViewerEventHandler;
...
public class EventPredictionSettingController extends AnchorPane implements Initializable{
  ...
  public void bind(EventPredictionSettingViewModel viewModel) {
    ...
    eventPredictionPeriodComboBox.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
      switch (eventPredictionPeriodComboBox.getSelectionModel().getSelectedIndex()){
        case 1 :
          usingOrbitPredictionDataBox.setVisible(true);
...
//    eventPredictionChart.setCircleData(50); Circle(Earth) Data Setting
    ...
    tabTextViewerEventHandler = new TabTextViewerEventHandler(this, eventMainTab);
