...
import ui.screen.common.*;
import ui.screen.orbitdeterminationBLSE.SelectableFilesTableRowViewModel;
...
public class EpochErrorSimulationController extends AnchorPane {
  ...
  private TabTextViewerEventHandler textViewerEventHandler;
  ...
  public void bind(EpochErrorSimulationViewModel viewModel) {
    ...
    textViewerEventHandler = new TabTextViewerEventHandler(this, epochErrorMainTab);
